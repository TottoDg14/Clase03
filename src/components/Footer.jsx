                    ...
                    <div className="row g-5">
                        ...
                        <div className="col-md-6 col-lg-6 col-xl-3">
                            <div className="footer-item d-flex flex-column">
                                ...
                                <a href="#"><i className="fas fa-angle-right me-2" /> Returns</a>
                                <a href="#"><i className="fas fa-angle-right me-2" /> Order History</a>
                                <a href="#"><i className="fas fa-angle-right me-2" /> Site Map</a>
                                <a href="#"><i className="fas fa-angle-right me-2" /> Testimonials</a>
                                <a href="#"><i className="fas fa-angle-right me-2" /> My Account</a>
                                <a href="#"><i className="fas fa-angle-right me-2" /> Unsubscribe Notification</a>
                            </div>
                        </div>
                        <div className="col-md-6 col-lg-6 col-xl-3">
                            <div className="footer-item d-flex flex-column">
                                ...
                                <a href="#"><i className="fas fa-angle-right me-2" /> Delivery infomation</a>
                                <a href="#"><i className="fas fa-angle-right me-2" /> Privacy Policy</a>
                                <a href="#"><i className="fas fa-angle-right me-2" /> Terms &amp; Conditions</a>
                                <a href="#"><i className="fas fa-angle-right me-2" /> Warranty</a>
                                <a href="#"><i className="fas fa-angle-right me-2" /> FAQ</a>
                                <a href="#"><i className="fas fa-angle-right me-2" /> Seller Login</a>
                            </div>
                        </div>
                        <div className="col-md-6 col-lg-6 col-xl-3">
                            <div className="footer-item d-flex flex-column">
                                <h4 className="text-primary mb-4">Extras</h4>
                                <a href="#"><i className="fas fa-angle-right me-2" /> Brands</a>
                                <a href="#"><i className="fas fa-angle-right me-2" /> Gift Vouchers</a>
                                <a href="#"><i className="fas fa-angle-right me-2" /> Affiliates</a>
                                <a href="#"><i className="fas fa-angle-right me-2" /> Wishlist</a>
                                <a href="#"><i className="fas fa-angle-right me-2" /> Order History</a>
                                <a href="#"><i className="fas fa-angle-right me-2" /> Track Your Order</a>
                                <a href="#"><i className="fas fa-angle-right me-2" /> Track Your Order</a>
                            </div>
                        </div>
                    </div>
