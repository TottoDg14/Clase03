...
const Navbar = () => {
    ...
    const pathParts = linkActive.split('/').filter(part => part !== '');
    return (
        <>
                    ...
                    <div className="col-12 col-lg-9">
                        <nav className="navbar navbar-expand-lg navbar-light bg-primary ">
                            ...
                            <div className="collapse navbar-collapse" id="navbarCollapse">
                                <div className="navbar-nav ms-auto py-0">
                                    <a href="/" className={`nav-item nav-link ${linkActive == '/home' || linkActive == '/' ? 'active' : ''}`}>Inicio</a>
                                    <a href="/store" className={`nav-item nav-link ${linkActive == '/store' ? 'active' : ''}`}>Tienda</a>
                                ...
                                <a className="btn btn-secondary rounded-pill py-2 px-4 px-lg-3 mb-3 mb-md-3 mb-lg-0"><i className="fa fa-mobile-alt me-2" /> +0123 456 7890</a>
                            </div>
                        </nav>
                    </div>
                </div>
